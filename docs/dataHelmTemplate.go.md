...
```go
import "github.com/cdktf/cdktf-provider-helm-go/helm/v8/datahelmtemplate"
...
&datahelmtemplate.DataHelmTemplateConfig {
	...
	Postrender: github.com/cdktf/cdktf-provider-helm-go/helm/v8.dataHelmTemplate.DataHelmTemplatePostrender,
