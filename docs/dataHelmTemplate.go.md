...
```go
import "github.com/cdktf/cdktf-provider-helm-go/helm/v11/datahelmtemplate"
...
&datahelmtemplate.DataHelmTemplateConfig {
	...
	Postrender: github.com/cdktf/cdktf-provider-helm-go/helm/v11.dataHelmTemplate.DataHelmTemplatePostrender,
