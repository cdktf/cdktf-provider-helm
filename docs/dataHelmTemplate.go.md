...
```go
import "github.com/cdktf/cdktf-provider-helm-go/helm/v7/datahelmtemplate"
...
&datahelmtemplate.DataHelmTemplateConfig {
	...
	Postrender: github.com/cdktf/cdktf-provider-helm-go/helm/v7.dataHelmTemplate.DataHelmTemplatePostrender,
