...
```go
import "github.com/cdktf/cdktf-provider-helm-go/helm/v5/datahelmtemplate"
...
&datahelmtemplate.DataHelmTemplateConfig {
	...
	Postrender: github.com/cdktf/cdktf-provider-helm-go/helm/v5.dataHelmTemplate.DataHelmTemplatePostrender,
