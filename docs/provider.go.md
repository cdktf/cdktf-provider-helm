...
```go
import "github.com/cdktf/cdktf-provider-helm-go/helm/v8/provider"
...
&provider.HelmProviderConfig {
	...
	BurstLimit: *f64,
	Debug: interface{},
	Experiments: github.com/cdktf/cdktf-provider-helm-go/helm/v8.provider.HelmProviderExperiments,
	HelmDriver: *string,
	Kubernetes: github.com/cdktf/cdktf-provider-helm-go/helm/v8.provider.HelmProviderKubernetes,
	PluginsPath: *string,
	Registry: interface{},
...
&provider.HelmProviderKubernetes {
	...
	ConfigPath: *string,
	ConfigPaths: *[]*string,
	Exec: github.com/cdktf/cdktf-provider-helm-go/helm/v8.provider.HelmProviderKubernetesExec,
	Host: *string,
	Insecure: interface{},
	Password: *string,
	ProxyUrl: *string,
