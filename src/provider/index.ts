// https://registry.terraform.io/providers/hashicorp/helm/2.13.2/docs
...
export class HelmProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing HelmProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/helm/2.13.2/docs#import import section} in the documentation of this resource for the id to use
